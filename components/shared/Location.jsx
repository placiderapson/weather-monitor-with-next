  ...
  return (
    <div className="Location">
      <div
        ...
        onClick={() => {
          setCurrentCity(context.state.cities[0]);
        }}
      >
        <div
          className={`Location__landmark-one Location__landmark--${locOneStyle}`}
        />
      ...
      <div
        className="Location__card"
        onClick={() => {
          setCurrentCity(context.state.cities[1]);
        }}
      >
        <div
          className={`Location__landmark-two Location__landmark--${locTwoStyle}`}
        />
        <div className="Location__country-city">
      ...
      <div
        className="Location__card"
        onClick={() => {
          setCurrentCity(context.state.cities[2]);
        }}
      >
        <div
          className={`Location__landmark-three Location__landmark--${locThreeStyle}`}
        />
        <div className="Location__country-city">
